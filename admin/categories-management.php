...
if ($search) {
    ...
    foreach ($keywords as $keyword) {
        $conditions[] = "(name LIKE '%$keyword%' OR link LIKE '%$keyword%')";
    }
    $whereClause = "WHERE " . implode(" AND ", $conditions);
}

$categoryQuery = "SELECT id, name, link, created_at, modified_at
                  FROM categories
                  $whereClause
...
$totalCategoriesQuery = "SELECT COUNT(*) AS total FROM categories $whereClause";
...
<head>
    ...
    <title>Furni Frenzy - Product Categories</title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center">View Product Categories</h2>
            <div class="header-container">
                ...
                <a href="http://localhost/ecommerce_project/admin/categories/create.php" class="btn btn-add-product btn-success ms-auto">Add Product</a>
                <!--<a href="add_category.php" class="btn btn-add-category ms-auto">Add Category</a>-->
            </div>
                    ...
                    <?php while ($row = $categoryResult->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="http://localhost/ecommerce_project/admin/categories/delete.php?id=<?= htmlspecialchars($row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this banner?');">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
