...
<section class="products">
            <div class="container">
              <h2 class="text-uppercase">Most <span>Popular</span></h2>
              ...
              <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div class="col">
                  ...
                  <a href="product-details.php?id=<?=$product['id'];?>" title="<?=$product['title'];?>">
                                <img src="<?=$webroot;?>uploads/<?=$product['picture'];?>" class="card-img-top" alt="Most Popular Image">
                            </a>
...
<section class="products">
    <div class="container">
        <h2 class="text-uppercase">New <span>Items</span></h2>
